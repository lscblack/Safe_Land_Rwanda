...
function ViewDetailsModal({ isOpen, onClose, mapping }: ViewDetailsModalProps) {
  ...
  const parseStatusDetails = (details: string | null): StatusDetails | null => {
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{mapping.size} m²</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Uploaded By:</span>
                    <span className="font-medium">User {mapping.uploaded_by}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{mapping.province}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">District:</span>
                    <span className="font-medium">{mapping.district}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Sector:</span>
                    <span className="font-medium">{mapping.sector}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Cell:</span>
                    <span className="font-medium">{mapping.cell}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Village:</span>
                    <span className="font-medium">{mapping.village}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Land Use Type:</span>
                    <span className="font-medium">{mapping.land_use_type}</span>
                  </div>
                </div>
              </div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  {statusDetails.official_registry_polygon && (
                    <div className="mt-3 pt-3 border-t border-gray-200">
                      <h4 className="font-medium text-sm mb-2">Official Registry Polygon</h4>
                      <div className="text-xs bg-gray-100 p-2 rounded overflow-auto max-h-32">
                        <code className="text-xs">{statusDetails.official_registry_polygon}</code>
                      </div>
                    </div>
                  )}
...
export default function MappingsManager() {
  ...
  useEffect(() => {
    ...
    const filtered = mappings.filter(mapping =>
      ...
      mapping.district.toLowerCase().includes(query) ||
      mapping.sector.toLowerCase().includes(query) ||
      mapping.cell.toLowerCase().includes(query) ||
      mapping.village.toLowerCase().includes(query) ||
      mapping.land_use_type.toLowerCase().includes(query)
    );
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search by UPI, ID, Property ID, Location..."
              value={searchQuery}
